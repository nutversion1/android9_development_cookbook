...
public class MainActivity<onStop> extends AppCompatActivity {
    ...
    private void createSoundPoolNew() {
        ...
        Toast.makeText(this, "createSoundPoolNew", Toast.LENGTH_SHORT).show();
    }
    ...
    private void createSoundPoolOld() {
        ...
        Toast.makeText(this, "createSoundPoolOld", Toast.LENGTH_SHORT).show();
    }
